...
1. Make sure you have a Project on the GCP Console to host your website.
...
bucket. Head to the [Storage][p6n-storage] section of the GCP Console, enter
your domain name (e.g. `www.example.com`), and create the bucket:
...
You will use [Cloud Build][gcb] and the [Build Triggers][bt] feature to upload
your website automatically every time you push a new git commit to the source
repository.
...
[Build Triggers][p6n-triggers] section, click “Run Trigger” and choose the branch
(i.e. master) to build.
...
following resources on the GCP Console to prevent incurring additional charges:
